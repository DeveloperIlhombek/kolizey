...
import Productlar from './productlar'
...
export const PulseBeams = () => {
	return (
		<div className='flex h-[100vh] relative items-center justify-center antialiased bg-slate-950 overflow-hidden'>
			<div className='bg-slate-800 text-center w-full z-40 h-[320px] no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-2xl p-px text-xs font-semibold leading-6  text-white inline-block'>
