			...
			<div className='relative z-10 container mx-auto px-4 sm:px-6 lg:px-8'>
				...
				>
					...
					<p className='text-white/70 text-lg lg:text-xl max-w-3xl mx-auto'>
						Yuqori sifatli rim ustunlari qoliplari. Professional ishlar uchun mo'ljallangan, 
						zamonaviy texnologiya asosida ishlab chiqarilgan mahsulotlar.
					</p>
				</motion.div>
					...
					<Tabs defaultValue='all' className='w-full'>
						...
						>
							<TabsList className='bg-slate-800/50 backdrop-blur-sm border border-white/10 p-1 rounded-xl'>
								...
								<TabsTrigger value='ustun' className='data-[state=active]:bg-amber-500 data-[state=active]:text-black text-white/70 px-4 py-2 rounded-lg font-medium transition-all duration-300'>
									Ustun
								</TabsTrigger>
								<TabsTrigger value='balyasina' className='data-[state=active]:bg-amber-500 data-[state=active]:text-black text-white/70 px-4 py-2 rounded-lg font-medium transition-all duration-300'>
									Balyasina
								</TabsTrigger>
								<TabsTrigger value='regel' className='data-[state=active]:bg-amber-500 data-[state=active]:text-black text-white/70 px-4 py-2 rounded-lg font-medium transition-all duration-300'>
									Regel
								</TabsTrigger>
								<TabsTrigger value='stakan' className='data-[state=active]:bg-amber-500 data-[state=active]:text-black text-white/70 px-4 py-2 rounded-lg font-medium transition-all duration-300'>
									Stakan
								</TabsTrigger>
								<TabsTrigger value='skameyka' className='data-[state=active]:bg-amber-500 data-[state=active]:text-black text-white/70 px-4 py-2 rounded-lg font-medium transition-all duration-300'>
									Skameyka
								</TabsTrigger>
							</TabsList>
						</motion.div>
	...
	if (items.length === 0) {
		return (
			...
			>
				...
				<p className='text-white/60 text-lg'>Bu kategoriyada mahsulot topilmadi</p>
			</motion.div>
		)
	}
				...
				>
					<Card
						className={cn(
							...
							isSelected(item.id) && 'ring-2 ring-amber-500 border-amber-500/70 bg-slate-900/70'
						)}
